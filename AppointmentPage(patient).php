                ...
                <?php foreach ($appointments as $appointment) { ?>
                    <tr>
                        ...
                        <td><button class="edit-btn"
                                    onclick="location.href='mcPatient.php?userType=patient&userID=<?= $patientID ?>&appointmentID=<?= $appointment['appointmentID'] ?>'">
                                Download
                            </button></td>
                        <td><?php if ($appointment['appointmentStatus'] == 'Pending') { ?>
                                <button class="edit-btn"
                                        onclick="location.href='updatingAppointment(pat).php?userType=patient&userID=<?= $patientID ?>&appointmentID=<?= $appointment['appointmentID'] ?>'">
                                    Update
                                </button>
                            <?php } ?>
                        </td>
